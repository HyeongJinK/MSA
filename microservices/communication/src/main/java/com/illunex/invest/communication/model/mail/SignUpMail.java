...
public class SignUpMail {
    ...
    public static String mail = "<!doctype html>\n" +
            ...
            "<body >\n" +
            "\t<!--*|IF:MC_PREVIEW_TEXT|*-->\n" +
            "\t<!--[if !gte mso 9]><!----><span class=\"mcnPreviewText\" style=\"display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;\">EffectMall for Startup</span>\n" +
            "\t<!--<![endif]-->\n" +
            "\t<!--*|END:IF|*-->\n" +
            "\t<center>\n" +
            "\t\t<table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" height=\"auto\" width=\"600px\" id=\"bodyTable\" style=\"background-color: gray;\">\n" +
            "\t\t\t<tr>\n" +
            ...
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<b style=\"font-size:18px; font-weight: 300;color: #00a4ff;\">{{userId}}</b>님!<br> 인증하기를 클릭하시면 회원가입이 완료됩니다.\n" +
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</p>\n" +
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tbody>\n" +
            ...
            "\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\n" +
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding-top:0; padding-right:0; padding-bottom:0; padding-left:0;\" valign=\"top\" align=\"center\" class=\"mcnButtonBlockInner\">\n" +
            ...
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t문의사항이 있으신경우 manager@illunex.com으로 문의해주세요.\n" +
            "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
